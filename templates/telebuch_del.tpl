  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="5">&nbsp;</td>
        <td width="467" align="left" class="name">{$nr}<input name="nr" type="hidden" value="{$nr}" /></td>
      </tr>
      <tr>
        <td align="right" class="name">Name:</td>
        <td>&nbsp;</td>
        <td align="left" class="name">{$name}<input name="_name" type="hidden" value="{$name}" /></td>
      </tr>
      <tr>
        <td colspan="3" align="center" class="name"><input type="submit" name="Submit" value="Loeschen" /></td>
        </tr>
    </table>
	</form>
	</td>
...
<div align="center" class="footer">
  <span class="zeit">Diese Seite wurde in {$zeit} Sekunden erstellt</span><br />
